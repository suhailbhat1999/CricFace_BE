...
from app.controllers.manager_controller import get_all_products, get_product_details, add_product, upload_image, delete_image,update_product, delete_product, \
...
manager_routes.route("/update_product/<int:prod_id>", methods=["POST"])(update_product)
manager_routes.route("/get_prod_details/<int:prod_id>", methods=["GET"])(get_product_details)
